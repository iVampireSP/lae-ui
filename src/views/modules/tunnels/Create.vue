                            ...
                            <n-grid cols="1 s:2" responsive="screen" x-gap="12">
                                ...
                                <n-gi>
                                    ...
                                    <n-form-item
                                            ...
                                            label="绑定域名"
                                            path="custom_domain">
                                        <n-input v-model:value="create_tunnel.custom_domain"
                                                 placeholder="输入一个存在的域名"/>
                                    </n-form-item>
                                    ...
                                    <n-form-item
                                            v-if="create_tunnel.protocol === 'xtcp' || create_tunnel.protocol === 'stcp'"
                                            label="密钥"
                                            path="sk">
                                ...
                                <n-gi>
                                    <n-form-item :label="'传输协议' + (isMobile ? '(可滑动)' : '')"
