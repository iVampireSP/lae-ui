                    ...
                    <n-grid cols="1 s:2" responsive="screen" x-gap="12">
                        ...
                        <n-gi>
                            <n-form-item label="内存">
                                <!--                <n-input v-model:value="create_gct.name" @keydown.enter.prevent/>-->
                                <n-slider v-model:value="create_gct.memory" :default-value="1024"
                            ...
                            <n-form-item label="存储大小">
                                <n-slider v-model:value="create_gct.disk" :default-value="1024"
                                          :format-tooltip="formatDiskTooltip"
                                          :max="65536" :min="1024"
                                          :show-tooltip="create_gct.disk > 4096" :step="512"/>
                            </n-form-item>
                            <n-form-item label="备份数量">
                                <n-slider v-model:value="create_gct.backups" :default-value="1"
